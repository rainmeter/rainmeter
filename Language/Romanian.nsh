...
${LangFileString} STANDARDINSTDESC        "Instalați Rainmeter cu setările recomandate."
${LangFileString} PORTABLEINST            "Instalare portabilă"
${LangFileString} PORTABLEINSTDESC        "Doar pentru utilizatori avansați. Nu vor fi create comenzi rapide și extensia .rmskin nu va fi înregistrată."
