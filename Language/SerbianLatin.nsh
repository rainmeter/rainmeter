...
${LangFileString} VCINSTERROR             "Instalacija Visual C++ $instArc nije uspela. Kôd greške: $0.$\n$\nProbajte da ručno preuzmete redistributable paket Visual C++ $instArc sa adrese http://rainmeter.net/redist$\n$\nKliknite 'U redu' za izlazak."
${LangFileString} DOTNETINSTERROR         "Instalacija .NET $instArc nije uspela. Kôd greške: $0.$\n$\nProbajte da ručno preuzmete redistributable paket .NET $instArc sa adrese http://rainmeter.net/redist$\n$\nKliknite 'U redu' za izlazak."
