...
${LangFileString} STANDARDINSTDESC        "התקן את Rainmeter עם ההגדרות המומלצות."
${LangFileString} PORTABLEINST            "התקנה ניידת"
${LangFileString} PORTABLEINSTDESC        "למשתמשים מתקדמים בלבד. קיצורי דרך לא ייווצרו וסיומת .rmskin לא תירשם."
