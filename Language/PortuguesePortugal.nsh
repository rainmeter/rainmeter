...
${LangFileString} PORTABLEINSTDESC        "Não selecione isto a não ser que saiba o que está a fazer. Os atalhos não serão criados e a extensão .rmskin não vai será registada. As bases de dados Visual C++ e .NET 2.0 terão de ser manualmente instaladas."
