...
${LangFileString} STANDARDINSTDESC        "Instale o Rainmeter com as definições recomendadas."
${LangFileString} PORTABLEINST            "Instalação portátil"
${LangFileString} PORTABLEINSTDESC        "Apenas para utilizadores avançados. Os atalhos não serão criados e a extensão . rmskin não será registada."
