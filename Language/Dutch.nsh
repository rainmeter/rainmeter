...
${LangFileString} VCINSTERROR             "Visual C++ $instArc installatie mislukt met foutcode $0.$\n$\nU kunt proberen Visual C++ 2010 SP1 $instArc herdistribueerbaar pakket handmatig te downloaden van http://rainmeter.net/redist$\n$\nDruk op OK om te sluiten."
...
${LangFileString} PORTABLEINSTDESC        "Niet selecteren tenzij u weet wat u doet. Snelkoppelingen zullen niet worden gemaakt en de .rmskin extensie zal niet geregistreerd worden. Mogelijk moeten de Visual C++ 2010 en .NET 2.0 bibliotheken handmatig geïnstalleerd worden."
