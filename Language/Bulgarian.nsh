${LangFileString} UNSUPPORTEDWINERROR     "Rainmeter ${VERSION_SHORT} не поддържа Windows 7/8. За да използвате Rainmeter под Windows 7/8, свалете по-старата Rainmeter 4.8 версия."
${LangFileString} ADMINERROR              "Нужни са административни права."
${LangFileString} LOGONERROR              "Услугата Logon service не е стартирана."
${LangFileString} UACERROR                "Нямате административни права."
...
${LangFileString} SETTINGSFILEERROR       "Файлът с опциите (Rainmeter.ini) се намира в инсталационната папка. Възможно е да възникнат проблеми при използване на програмата от повече от един потребител или от някого с ограничени права.$\n$\nИскате ли да преместите файла в потребителската папка за данни?"
${LangFileString} SETTINGSMOVEERROR       "Файлът '$INSTDIR\Rainmeter.ini' не може да бъде преместен в '$APPDATA\Rainmeter\Rainmeter.ini'."
...
${LangFileString} STANDARDINSTDESC        "Инсталирайте Rainmeter с препоръчителните настройки."
${LangFileString} PORTABLEINST            "Портативна инсталация"
${LangFileString} PORTABLEINSTDESC        "Само за напреднали потребители. Няма да бъдат създадени преки пътища и разширението .rmskin няма да бъде регистрирано."
...
${LangFileString} SENDINFORMATION         "Изпраща информация за този компютър"
${LangFileString} SENDINFORMATIONDESC     "Версията на Вашия Windows, езиковите настройки и хардуерните данни ще бъдат изпратени на производителя на този софтуер по време на инсталацията, с цел подобряване на Rainmeter. Няма да бъдат изпращани никакви лични данни."
