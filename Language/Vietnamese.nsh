...
${LangFileString} STANDARDINSTDESC        "Cài đặt Rainmeter với các thiết lập được đề xuất."
${LangFileString} PORTABLEINST            "Bản cài đặt Portable"
${LangFileString} PORTABLEINSTDESC        "Chỉ dành cho người dùng nâng cao. Phím tắt sẽ không được tạo và phần mở rộng .rmskin sẽ không được đăng ký."
