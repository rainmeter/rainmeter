...
${LangFileString} VCINSTERROR             "Установка Visual C++ $instArc завершилась с кодом ошибки $0.$\n$\nВы можете попробовать загрузить распространяемый пакет Visual C++ $instArc вручную из http://rainmeter.net/redist$\n$\nНажмите кнопку OK для выхода."
${LangFileString} DOTNETINSTERROR         "Установка .NET $instArc завершилась с кодом ошибки $0.$\n$\nВы можете попробовать загрузить распространяемый пакет .NET $instArc вручную из http://rainmeter.net/redist$\n$\nНажмите кнопку OK для выхода."
...
${LangFileString} PORTABLEINSTDESC        "Не выбирайте это, если вы не знаете, что вы делаете. Ярлыки не будут созданы, и .rmskin расширение не будет зарегистрировано. Может потребоваться вручную установить библиотеки Visual C++ и .NET 2.0."
