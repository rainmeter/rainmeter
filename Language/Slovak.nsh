${LangFileString} UNSUPPORTEDWINERROR     "Rainmeter ${VERSION_SHORT} nepodporuje systém Windows 7/8. Na používanie programu Rainmeter v systéme Windows 7/8 si stiahnite staršiu verziu programu Rainmeter 4.8."
...
${LangFileString} STANDARDINSTDESC        "Nainštalujte Rainmeter s odporúčanými nastaveniami."
${LangFileString} PORTABLEINST            "Portable inštalácia"
${LangFileString} PORTABLEINSTDESC        "Len pre pokročilých používateľov. Skratky nebudú vytvorené a prípona .rmskin nebude zaregistrovaná."
