${LangFileString} UNSUPPORTEDWINERROR     "Rainmeter ${VERSION_SHORT} 不支援 Windows 7/8。如果要在 Windows 7/8 上執行 Rainmeter，請下載 Rainmeter 4.8 或更早版本。"
...
${LangFileString} PORTABLEINSTDESC        "如果不瞭解此項目，請勿選取。便攜式安裝不會建立快捷方式、也不會與 rmskin 檔案關聯。可能還需要手動下載安裝 Visual C++ 和 .NET 2.0 組件庫。"
...
${LangFileString} SENDINFORMATIONDESC     "Rainmeter 安裝程式會在安裝過程中將目前 Windows 版本、語言以及硬體效能等資訊回報給我們，以協助我們讓 Rainmeter 變得更好。資訊回報不會傳送的任何個人資訊。"
