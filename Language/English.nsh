${LangFileString} UNSUPPORTEDWINERROR     "Rainmeter ${VERSION_SHORT} does not support Windows 7/8. To use Rainmeter on Windows 7/8, download the older Rainmeter 4.8 version."
...
${LangFileString} STANDARDINSTDESC        "Install Rainmeter with the recommended settings."
${LangFileString} PORTABLEINST            "Portable installation"
${LangFileString} PORTABLEINSTDESC        "For advanced users only. Shortcuts will not be created and the .rmskin extension will not be registered."
