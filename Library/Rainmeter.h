...
enum
{
	...
	WM_RAINMETER_HANDLE_NET_TASK_RESULT = WM_APP + 100,
...
public:
	...
	int GetForceScale() { return m_ForceScale; }
	void SetForceScale(int scale);
	bool GetSkinScaleDefined() { return m_SkinScaleDefined; }
