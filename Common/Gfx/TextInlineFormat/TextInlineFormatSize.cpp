...
TextInlineFormat_Size::TextInlineFormat_Size(const std::wstring pattern, const FLOAT size) :
...
bool TextInlineFormat_Size::CompareAndUpdateProperties(const std::wstring pattern, const FLOAT size)
{
